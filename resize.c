...
int main(int argc, char* argv[])
{
    ...
    // set new file size
    new_bf.bfSize = sizeof(BITMAPFILEHEADER) + sizeof(BITMAPINFOHEADER) + (new_bi.biWidth * sizeof(RGBTRIPLE) + new_padding) * abs(new_bi.biHeight);
    new_bi.biSizeImage = new_bf.bfSize - sizeof(BITMAPFILEHEADER) + sizeof(BITMAPINFOHEADER);
